...
DROP POLICY IF EXISTS "Super admin can view all api usage" ON public.api_usage_tracking;
...
DROP POLICY IF EXISTS "Super admin can manage all data exports" ON public.data_exports;
...
DROP POLICY IF EXISTS "Super admin can manage all deletion requests" ON public.account_deletion_requests;
...
DROP POLICY IF EXISTS "Super admin can manage all application settings" ON public.application_settings;
...
DROP POLICY IF EXISTS "Super admin can manage all integration settings" ON public.integration_settings;
...
DROP POLICY IF EXISTS "Super admin can view all validation logs" ON public.ai_validation_logs;
...
DROP POLICY IF EXISTS "Super admin can manage all company profiles" ON public.company_profiles;
...
DROP POLICY IF EXISTS "Super admin can manage affiliate programs" ON public.affiliate_programs;
...
DROP POLICY IF EXISTS "Super admin can manage affiliate links" ON public.affiliate_links;
