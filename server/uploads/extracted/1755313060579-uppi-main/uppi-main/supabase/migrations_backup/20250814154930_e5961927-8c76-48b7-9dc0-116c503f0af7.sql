...
-- Create admin-only access for admin API keys (using is_admin_user function)
...
-- Add constraint to ensure API keys are properly structured
ALTER TABLE public.api_keys 
DROP CONSTRAINT IF EXISTS encrypted_api_key_check,
