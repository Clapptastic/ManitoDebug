-- Remaining Missing Tables from Phases 13-25
-- First remove email references that were causing issues and create those separately
...
-- Phase 25: Email Events and Preferences (now that email_queue exists)
-- Email Events
