-- Fix the search path security issue for the manage_api_key_vault function
  ...
  CASE operation
    WHEN 'insert' THEN
      ...
      result := json_build_object(
        ...
        'masked_key', (SELECT masked_key FROM public.api_keys WHERE user_id = user_id_param AND provider = provider_param)
      );
