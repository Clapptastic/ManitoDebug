...
DROP POLICY IF EXISTS "Admins can view all API usage costs" ON public.api_usage_costs;
CREATE POLICY "Admins can view all API usage costs" 
...
-- Drop existing policies and recreate them to allow users to view model versions
...
-- Recreate the calculate_data_completeness_score function
