-- Drop and recreate the manage_api_key function with correct return type
DROP FUNCTION IF EXISTS public.manage_api_key(text, uuid, text, text, text, text, text, uuid);
