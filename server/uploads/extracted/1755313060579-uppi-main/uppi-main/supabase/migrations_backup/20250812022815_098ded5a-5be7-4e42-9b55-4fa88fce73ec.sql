-- Reattempt migration: drop and recreate RPC with expanded return type
BEGIN;

-- Ensure columns exist
ALTER TABLE public.competitor_analyses
  ADD COLUMN IF NOT EXISTS brand_strength_score numeric,
  ADD COLUMN IF NOT EXISTS operational_efficiency_score numeric,
...
-- Recreate with new return type including new fields
