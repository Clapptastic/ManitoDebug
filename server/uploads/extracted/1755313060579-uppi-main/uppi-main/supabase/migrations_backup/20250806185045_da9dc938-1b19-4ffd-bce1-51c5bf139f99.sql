...
-- These tables should have proper RLS but currently allow null user_ids
...
-- 5. Fix inconsistent service role access

-- Ensure service role has proper access to critical tables
