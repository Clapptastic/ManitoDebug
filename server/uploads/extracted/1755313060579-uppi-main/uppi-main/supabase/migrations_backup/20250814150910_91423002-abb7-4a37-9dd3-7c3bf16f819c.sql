...
-- Set search_path to 'public' for all functions to prevent search path manipulation attacks

-- Update the functions we just created with secure search_path
...
-- Update get_user_api_key_for_validation with secure search_path
...
-- Update update_api_key_status with secure search_path
...
-- Update log_application_error with secure search_path
...
-- Update get_system_health with secure search_path
...
-- Update cleanup_old_sessions with secure search_path
