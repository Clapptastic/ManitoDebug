...
-- Allow admins to view all API usage costs
CREATE POLICY IF NOT EXISTS "Admins can view all API usage costs" 
...
CREATE POLICY IF NOT EXISTS "Users can select their own documents" 
ON public.documents 
FOR SELECT 
