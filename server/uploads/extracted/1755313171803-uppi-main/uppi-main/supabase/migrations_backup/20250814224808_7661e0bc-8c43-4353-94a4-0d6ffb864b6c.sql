-- Clean up ALL conflicting function versions with specific signatures
...
DROP FUNCTION IF EXISTS public.vault_retrieve_api_key(text, uuid, text);
DROP FUNCTION IF EXISTS public.vault_retrieve_api_key(text, text, uuid, text, text);
