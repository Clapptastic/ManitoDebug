-- Drop existing function first and recreate vault functions for API keys

-- Drop existing function that's preventing update
DROP FUNCTION IF EXISTS vault_store_api_key(uuid,text,text,text);
