-- Fix API key issues without changing parameter names to avoid conflicts
-- Update only the function body without changing the existing signature

-- Update manage_api_key_vault to handle operation mapping properly
