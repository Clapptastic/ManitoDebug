...
-- Helpful comment: This function runs as SECURITY DEFINER and enforces that only the
-- authenticated user (or service/admin) can create their own analysis run while bypassing
-- table-level permission glitches. It returns the id of the new row.
