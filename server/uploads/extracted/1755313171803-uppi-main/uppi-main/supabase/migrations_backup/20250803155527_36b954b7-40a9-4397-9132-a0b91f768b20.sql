-- Fix the calculate_data_completeness_score function that appears to be missing
-- This function is called by triggers when inserting/updating competitor_analyses
